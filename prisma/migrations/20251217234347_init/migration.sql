...
-- CreateIndex
CREATE INDEX "QuizResult_wordId_idx" ON "QuizResult"("wordId");
...
-- AddForeignKey
ALTER TABLE "QuizResult" ADD CONSTRAINT "QuizResult_wordId_fkey" FOREIGN KEY ("wordId") REFERENCES "Word"("id") ON DELETE CASCADE ON UPDATE CASCADE;
